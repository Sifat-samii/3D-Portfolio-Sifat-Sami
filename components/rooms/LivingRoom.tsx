...
import { scaleWorldZ, Z_PIVOT_SOUTH } from "@/lib/roomLayout";
  ...
  return (
    <RoomShell
      ...
      openings={[
        ...
        { side: "west", offset: 3.9, width: 2.4 }, // → Music (lower)
        { side: "east", offset: -7.8, width: 2.4 }, // → Professional (upper)
        { side: "east", offset: 3.9, width: 2.4 }, // → Web (lower)
    ...
    >
      <FurnitureBox position={[0, 0.45, z(2.4)]} scale={[3.4, 0.7, 1.1]} color="#3a2d28" />
      <FurnitureBox position={[0, 0.85, z(2.95)]} scale={[3.4, 0.18, 0.35]} color="#4a3a32" />
      <FurnitureBox position={[1.4, 0.85, z(2.4)]} scale={[0.4, 0.2, 1.05]} color="#4a3a32" />
      <FurnitureBox position={[-1.4, 0.85, z(2.4)]} scale={[0.4, 0.2, 1.05]} color="#4a3a32" />

      <FurnitureBox position={[0, 0.08, z(0.4)]} scale={[4.2, 0.06, 2.4]} color="#9a5224" />
      <FurnitureBox position={[0, 0.3, z(0.4)]} scale={[1.8, 0.05, 1.1]} color="#7c2d12" emissive="#fb923c" />

      <FurnitureBox position={[0, 0.45, z(-1.4)]} scale={[1.8, 0.4, 1]} color="#4b372c" />
      <FurnitureBox position={[0, 0.85, z(-1.4)]} scale={[1.4, 0.05, 0.6]} color="#1c1917" emissive="#f59e0b" />
      <BookStack position={[-0.5, 0.85, z(-1.4)]} color="#7c2d12" />
      <CoffeeMug position={[0.5, 0.85, z(-1.4)]} color="#fde68a" />
      <Notebook position={[0.1, 0.85, z(-1.4)]} color="#e2e8f0" />

      <FloorLamp position={[-5.8, 0.2, z(-4.2)]} color="#ffb84d" />
      <Plant position={[-4.8, 0.2, z(-0.5)]} color="#166534" />
      <Plant position={[5.6, 0.2, z(-0.8)]} color="#15803d" />

      <FurnitureBox position={[5, 0.45, z(3.5)]} scale={[2.2, 0.7, 1.1]} color="#433021" />
      <FurnitureBox position={[5, 0.85, z(3.5)]} scale={[2.2, 0.04, 1.1]} color="#1c1917" />

      <FramedArt
        position={[0, 2.2, z(-15.85)]}
        width={2.4}
        height={1.4}
        color="#fbbf24"
      />
      <FramedArt
        position={[-5.6, 2.2, z(0)]}
      ...
      <FurnitureCylinder position={[-3.4, 0.2, z(4.2)]} scale={[0.5, 0.4, 0.5]} color="#7c2d12" />
      <FurnitureCylinder position={[3.4, 0.2, z(4.6)]} scale={[0.45, 0.4, 0.45]} color="#92400e" />

      {/* ── GRAND MAIN ENTRANCE — south wall (z = 6), centered ──────── */}
      <group position={[0, 0, Z_PIVOT_SOUTH]}>
